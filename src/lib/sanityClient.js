...
export const sanityClient = createClient({
    projectId: import.meta.env.VITE_SANITY_PROJECT_ID || 'demo_project_id', // Burayı README'ye göre dolduracağız
...
export const isSanityConfigured = () => {
    return import.meta.env.VITE_SANITY_PROJECT_ID && import.meta.env.VITE_SANITY_PROJECT_ID !== 'demo_project_id';
};
